 ...
 *                      Fokus utama: Menampilkan identitas dan logo aplikasi (Stream Radar gRPC-Web).
 *
 * Changelog:
  ...
  return (
    <header className="flex items-center justify-between px-8 py-5 bg-white border-b border-surface-200">
      <div className="flex items-center">
        <h1 className="text-xl font-bold text-surface-900 uppercase">Performancetest_Grpcweb</h1>
      </div>
      
      <nav className="flex items-center">
        <a href="#" className="uppercase text-orange-400 font-bold text-sm tracking-wider border-b-2 border-orange-400 pb-1">
          Dashboard
        </a>
      </nav>
