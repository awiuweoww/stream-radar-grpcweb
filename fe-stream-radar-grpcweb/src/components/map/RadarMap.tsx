...
/**
 * Komponen Peta Radar utama yang mengintegrasikan OpenLayers.
 * Menampilkan posisi target, efek sapuan radar, dan kontrol peta.
 * 
 * @returns Elemen JSX kontainer peta radar.
 */
