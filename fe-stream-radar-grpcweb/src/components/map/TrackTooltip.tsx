...
export const TrackTooltip = forwardRef<HTMLDivElement, TrackTooltipProps>(({ data }, ref) => {
  return (
    ...
    >
        {data && (
        <>
            <div className="font-bold border-b border-surface-700 pb-1.5 mb-2.5 text-orange-400 capitalize tracking-wide flex items-center gap-2">
            ...
            <div className="flex justify-between gap-4 items-center">
                ...
                <span className="bg-surface-800 text-orange-400 px-1.5 py-0.5 rounded text-[10px] font-bold">
