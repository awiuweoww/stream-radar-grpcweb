...
export const MapToolbar: React.FC<MapToolbarProps> = ({ 
  ...
  return (
    <div className="absolute top-6 right-6 z-20 flex flex-col gap-2">
      <button onClick={onCenter} className="w-10 h-10 flex items-center justify-center bg-white/90 backdrop-blur text-surface-900 rounded shadow hover:bg-orange-50 hover:text-orange-600 transition-colors group" aria-label="Center Map">
      ...
      <button onClick={onZoomIn} className="w-10 h-10 flex items-center justify-center bg-white/90 backdrop-blur text-surface-900 rounded shadow hover:bg-orange-50 hover:text-orange-600 transition-colors group" aria-label="Zoom In">
      ...
      <button onClick={onZoomOut} className="w-10 h-10 flex items-center justify-center bg-white/90 backdrop-blur text-surface-900 rounded shadow hover:bg-orange-50 hover:text-orange-600 transition-colors group" aria-label="Zoom Out">
      ...
      <button onClick={onToggleMapType} className="w-10 h-10 flex items-center justify-center bg-white/90 backdrop-blur text-surface-900 rounded shadow hover:bg-orange-50 hover:text-orange-600 transition-colors group" aria-label="Ganti Peta">
