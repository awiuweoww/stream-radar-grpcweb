 ...
 *                      Fokus utama: Membaca status Real-time dari Zustand Store untuk diperlihatkan ke antarmuka pengguna.
 *
 * Arsitektur:
  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <div className="bg-white rounded p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-surface-100 flex flex-col justify-center">
        <span className="text-orange-400 font-bold uppercase tracking-widest text-xs mb-2">FPS</span>
        <div className="text-6xl font-extrabold text-surface-900 tracking-tight">{fps.toFixed(1)}</div>
      </div>
      
      <div className="bg-white rounded p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-surface-100 flex flex-col justify-center">
        <span className="text-orange-400 font-bold uppercase tracking-widest text-xs mb-2">Total Objects</span>
