/**
 * Tanggal Pembuatan   : 13-04-2026
 * Deskripsi           : Komponen kontrol simulasi untuk memulai dan menghentikan simulasi radar.
 *                       Bertanggung jawab untuk mengubah status global simulasi.
 *
 * Arsitektur:
 *   SimulationControls (Trigger) ──► useSimulationStore ──► useRadarSimulation
 *
 * Changelog:
 *   - 0.1.0 (13-04-2026): Inisialisasi komponen kontrol simulasi.
 */
    ...
    <div className="flex flex-col gap-3 mt-2">
      ...
      >
        ...
        <input 
            ...
            disabled={isActive}
            className={`w-24 bg-white border border-surface-200 text-surface-900 rounded py-1 px-2 text-right font-mono font-bold focus:outline-none focus:border-orange-400 
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        className={`flex items-center justify-center gap-3 py-5 font-bold uppercase tracking-widest text-white transition-all 
          ${isActive ? 'bg-orange-300 cursor-not-allowed' : 'bg-orange-400 hover:bg-orange-500 hover:shadow-lg'}`}
      >
